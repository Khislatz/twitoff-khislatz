...
if __name__ == "__main__":
    ...
    pprint(user._json)
    print(user.id)
    print(user.screen_name) # elonmusk
    ...
    #dir(tweets[0]) contains parameter full_text 
    # we could do: tweet[0].full_text and we will get the full text of the first tweet
